...
TestRail.prototype.getCaseIdByTitle = function(obj) {
    if(obj.hasOwnProperty('case_id')) return this.promise(obj.case_id);
...
TestRail.prototype.getMilestoneIdByName = function(obj) {
    if(obj.hasOwnProperty('milestone_id')) return this.promise(obj.milestone_id);
...
TestRail.prototype.getPlanIdByName = function(obj) {
    if(obj.hasOwnProperty('plan_id')) return this.promise(obj.plan_id);
...
TestRail.prototype.getProjectIdByName = function(obj) {
    if(obj.hasOwnProperty('project_id')) return this.promise(obj.project_id);
...
TestRail.prototype.getSectionIdByName = function(obj) {
    if(obj.hasOwnProperty('section_id')) return this.promise(obj.section_id);
    return this.getSections(obj).then(function(json){
...
TestRail.prototype.getSuiteIdByName = function(obj) {
    if(obj.hasOwnProperty('suite_id')) return this.promise(obj.suite_id);
...
TestRail.prototype.getLatestRunInPlan = function(obj) {
    var tr = this;
    if(obj.hasOwnProperty('run_id')) return tr.promise(obj.run_id);
