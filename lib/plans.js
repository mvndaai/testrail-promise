...
TestRail.prototype.addPlanEntry = function(obj) { //TODO test
...
TestRail.prototype.updatePlanEntry = function(obj) { //TODO test
...
TestRail.prototype.closePlan = function(obj) { //TODO test
...
TestRail.prototype.deletePlanEntry = function(obj) { //TODO test
    var path = "update_plan_entry/" + obj.plan_id + "/" + obj.entry_id;
    return this.post(path, obj);
};
