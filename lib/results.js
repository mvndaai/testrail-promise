...
TestRail.prototype.getResults = function(obj) { //TODO test
    return this.get("get_results/" + obj.test_id);
};

//http://docs.gurock.com/testrail-api2/reference-results#get_results_for_case
TestRail.prototype.getResultsForCase = function(obj) { //TODO test
    return this.get("get_results_for_case/" + obj.run_id + "/" + obj.case_id);
};

//http://docs.gurock.com/testrail-api2/reference-results#get_results_for_run
TestRail.prototype.getResultsForRun = function(obj) { //TODO test
    return this.get("get_results_for_run/" + obj.run_id);
};

//http://docs.gurock.com/testrail-api2/reference-results#add_result
TestRail.prototype.addResult = function(obj) { //TODO test
    return this.post("add_result/" + obj.test_id, obj);
};

//http://docs.gurock.com/testrail-api2/reference-results#add_result_for_case
TestRail.prototype.addResultForCase = function(obj) { //TODO test
